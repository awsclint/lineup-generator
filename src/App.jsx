...
function App() {
  ...
  console.log('Softball Lineup Generator v1.2.0 loaded');
      ...
      <div style="width: 100%; max-width: 8.5in; margin: 0 auto; font-family: Arial, sans-serif;">
        ...
        <footer className="app-footer">
          <div className="footer-content">
            <p>Generated by Softball Lineup Generator v1.2.0</p>
            <p>
              <a 
                href="https://github.com/awsclint/lineup-generator" 
                target="_blank" 
  ...
  return (
    <div className="App">
      ...
      <footer className="app-footer">
        <div className="footer-content">
          <p>Generated by Softball Lineup Generator</p>
          <p>
            <a 
              href="https://github.com/awsclint/lineup-generator" 
              target="_blank" 
